...
/* Subject line */
$subject = "Contact from eisenmond.ch";

/* Site URL */
$site_url = "https://eisenmond.ch";

/* Site Name */
$site_name = "eisenmond.ch";
...
$message = $message . PHP_EOL.PHP_EOL."-- ".PHP_EOL."Automatisierter Nachrichtendienst von eisenmond.ch";
...
<head>
	...
	<title>Vielen Dank, dass Sie mit <?php print $site_name; ?> Kontakt aufnehmen!</title>
	<style>
...
<body>
	<div id="thankyou">
		<p><strong>Vielen Dank, Ihre Nachricht wurde versandt</strong></p>
		<p>Wenn Sie nicht innert 5 Sekunden weitergeleitet werden <a href="<?php print $continue; ?>">klicken Sie hier um zurück zur Homepage zu kehren!</a></p>
	</div>
</body>
</html>
